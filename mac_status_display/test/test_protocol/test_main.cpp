...
void test_valid_frame() {
  ...
  buildFrame("MSD2,42,123,876,557,1048576,4096,10,5", line, sizeof(line));
...
void test_missing_temperature() {
  char line[macstatus::kMaximumFrameLength + 1];
  buildFrame("MSD2,0,0,1000,-32768,0,0,50,5", line, sizeof(line));
  macstatus::StatusFrame frame = {};
  TEST_ASSERT_TRUE(macstatus::parseStatusFrame(line, frame));
...
void test_bad_crc_is_rejected_without_mutating_output() {
  char line[] = "$MSD2,42,123,876,557,1,2,50,5*0000";
  macstatus::StatusFrame frame = {7, 8, 9, 10, 11, 12, 13, 14};
...
void test_out_of_range_and_extra_fields_are_rejected() {
  ...
  buildFrame("MSD2,1,1001,20,500,1,2,50,5", cpuLine, sizeof(cpuLine));
  buildFrame("MSD2,1,10,20,500,1,2,101,5", brightnessLine, sizeof(brightnessLine));
  buildFrame("MSD2,1,10,20,500,1,2,50,5,3", extraLine, sizeof(extraLine));
  macstatus::StatusFrame frame = {};
